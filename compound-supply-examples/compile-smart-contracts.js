...
const myContractFileName = 'LFGlobalEscrow.sol';
const MyContractName = 'LFGlobalEscrow';
const myContractFilePath = `./compound-supply-examples/solidity-contracts/${myContractFileName}`;
