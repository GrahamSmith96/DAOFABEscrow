...
const myContractAddress = '0xFE54b6433785375807850e5E5DFA4b4e2aD1c0aA';
const myAbi = require('./.build/abi.json');
const myContract = new web3.eth.Contract(myAbi, myContractAddress);

// Rinkeby contract address and ABI for cETH, which can be found in the mainnet
// tab on this page: https://compound.finance/developers
const compoundCEthContractAddress = '0xd6801a1dffcd0a410336ef88def4320d6df1883e';
